...
return (
  <div>
    { gameOver ? (
    <h1 className='text-3xl mt-4 font-mono'>Game Over</h1>
    )  : (
    <>
      <h1 className='text-4xl text-center mt-10 font-mono'>Which of the following countries have the larger population?</h1>
    <div className='flex my-20 mb-40'>
         {gameCountries.map((country, index) => (
          ...
          <img src={country.flag} alt="germanyflag" className="w-full rounded-t-lg" />
              <div className='ml-8 mt-2 font-mono'>
        ...
        <div className='flex flex-col mt-20 ml-20'>
            <h1 className='text-3xl mt-8 ml-20 font-mono'>Score: {score}</h1>
            <h1 className='text-3xl mt-8 ml-20 font-mono'>Lives: {lives}</h1>
        ...
        <button 
          ...
          className="mt-20 bg-black hover:bg-blue-200 text-white mx-10 my-10 font-bold py-2 px-4 rounded font-mono">Go again
          </button>
